    ...
    >
      <div className="flex flex-row w-full  ">
        <div className="relative rounded-lg overflow-hidden w-full">
          ...
          <div className="relative flex flex-col w-full p-2 backdrop-blur-sm bg-black/60  rounded-lg">
            <div className="flex flex-row justify-between text-center  ">
              ...
              <p className=" flex flex-col w-full items-end gap-2 text-md font-bold">
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <Progress
          ...
          size="lg"
          color="green"
          className=" text-xs text-white bg-gray-500   border-2 border-gray-900 rounded-md transition-all duration-300 ease-out"
          textLabel="Progress "
          labelProgress
          labelText
        />
      ...
      {teamHistory && (
        <div className="flex flex-row w-full justify-between p-2 bg-white/50 rounded-md">
          <h4 className="text-xs font-semibold text-black">History:</h4>
          <div className="h-full max-sm:h-10 overflow-y-auto flex flex-col gap-0">
